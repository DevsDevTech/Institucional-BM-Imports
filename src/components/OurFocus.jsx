...
function OurFocus() {
  return (
    <div className="flex flex-col xl:justify-center xl:items-center overflow-auto max-lg:gap-2 lg:gap-6">
      <div className="flex flex-col gap-2 max-md:px-4 md:px-10 lg:px-15 xl:px-22 2xl:px-32">
      <p className="flex items-center justify-center font-bold text-xl lg:text-2xl">
        Nossa missão
      </p>
      <p className="flex items-center justify-center font-semibold text-lg lg:text-xl">Nosso propósito é entregar valor e confiança.</p>
      ...
      <div className="flex xl:justify-center xl:items-center overflow-auto pb-3">
        ...
        >
          <DollarSign className="text-blue-800 mb-2" size={64} />

          <p className="text-lg lg:text-xl font-semibold text-justify lg:py-4">
        ...
        >
          <ShoppingCart className="text-blue-800 mb-2" size={64} />
          <p className="text-lg lg:text-xl font-semibold text-justify lg:py-4">
        ...
        rounded-lg w-[370px] p-6 hover:scale-101 hover:shadow-lg duration-300 bg-white mx-4 flex-shrink-0 shadow-md"
        >
          <Headset className="text-blue-800 mb-2" size={64} />
          <p className="text-lg lg:text-xl font-semibold text-justify">
            Mantemos um pós-venda diferenciado, oferecendo suporte próximo aos nossos clientes.
          </p>
        </div>
      </div>
    </div>
